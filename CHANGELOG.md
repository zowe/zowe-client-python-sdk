...
- Fixed URI-encode USS paths, file system names, volume serials, and console names. Fix Console.issue_command/get_response corrupting URLs when the host or base path contains defcn. [#408](https://github.com/zowe/zowe-client-python-sdk/pull/408)
